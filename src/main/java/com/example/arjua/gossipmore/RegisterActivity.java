...
public class RegisterActivity extends AppCompatActivity {
        ...
        mCreateBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(!TextUtils.isEmpty(display_name) || !TextUtils.isEmpty(email) || !TextUtils.isEmpty(password)){
                    ...
                    employee.setName(display_name);
                    employee.setEmail(email);
                    employee.setPassword(password);
                    String eid=databaseReference.push().getKey();
                    databaseReference.child("usersinfo").child(eid).setValue(employee);*/
    ...
    private void register_user(final String display_name, String email, final String password) {
